...
fis = addMF(fis, 'Tiempo_Lavado', 'trimf', [15 25 40], Name='Medio');
fis = addMF(fis, 'Tiempo_Lavado', 'trimf', [30 45 60], Name='Largo');

fis = addOutput(fis, [0 100], Name='Detergente');

fis = addMF(fis, 'Detergente', 'trimf', [0 10 15], Name='Poco');
fis = addMF(fis, 'Detergente', 'trimf', [15 45 70], Name='Normal');
