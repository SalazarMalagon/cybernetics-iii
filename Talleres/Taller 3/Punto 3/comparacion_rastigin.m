% Comparación entre GA y PSO para la función Rastrigin
% preambulo
clear;clc; close all;
set(0,'DefaultLineLineWidth',2)
set(0, 'defaultfigurecolor', [1 1 1])

% Óptimo teórico de la función Rastrigin
% El mínimo global está en (0,0) con valor f = 0
optimo_teorico_x = 0;
optimo_teorico_y = 0;
optimo_teorico_valor = rastigin([optimo_teorico_x; optimo_teorico_y]);

fprintf('=== FUNCIÓN RASTRIGIN - COMPARACIÓN GA vs PSO ===\n');
...
for i = 1:num_runs
    ...
    % Ejecutar GA
    tic;
    [x_ga, fval_ga, exitflag_ga, output_ga] = ga(@rastigin, NV, optionsga);
    time_ga = toc;
    ...
    % Ejecutar PSO
    tic;
    [x_pso, fval_pso, exitflag_pso, output_pso] = particleswarm(@rastigin, NV, lb, ub, options_pso);
    time_pso = toc;
...
sgtitle('Comparación GA vs PSO - Función Rastrigin');
